...
IUSE="clippy cpu_flags_x86_sse2 debug dist doc libcxx llvm-libunwind miri nightly parallel-compiler rls rustfmt rust-src system-bootstrap system-llvm test wasm ${ALL_LLVM_TARGETS[*]}"
...
src_configure() {
	...
	cat <<- _EOF_ > "${S}"/config.toml
		...
		llvm-libunwind = "$(usex elibc_musl system no)"
